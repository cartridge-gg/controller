...
export type AccountQuery = {
  ...
  account?: {
    ...
    type: AccountType;
    contractAddress?: string | null;
    credential: { __typename?: "Credential"; id: string; publicKey: string };
    contracts: {
      __typename?: "ContractConnection";
      edges?: Array<{
        __typename?: "ContractEdge";
  ...
  transactions?: {
    ...
    edges?: Array<{
      ...
      node?: {
        ...
        metadata?:
          | { __typename: "AccountUpgrade"; implementation: string }
          | { __typename: "ContractDeploy"; type: ContractType }
          | {
              __typename: "FungibleTransfer";
              from: string;
              to: string;
          ...
          | { __typename: "Mint"; to: string; tokenId: any; amount: any }
          | {
              __typename: "NonFungibleTransfer";
              from: string;
              to: string;
...
>(
  ...
  useQuery<TransactionsQuery, TError, TData>(
    ...
    useFetchData<TransactionsQuery, TransactionsQueryVariables>(
      TransactionsDocument,
    ).bind(null, variables),
    options,
  );

useTransactionsQuery.getKey = (variables: TransactionsQueryVariables) => [
  "Transactions",
  variables,
];
...
>(
  ...
  const query = useFetchData<TransactionsQuery, TransactionsQueryVariables>(
    TransactionsDocument,
  );
...
useInfiniteTransactionsQuery.getKey = (
  variables: TransactionsQueryVariables,
) => ["Transactions.infinite", variables];
