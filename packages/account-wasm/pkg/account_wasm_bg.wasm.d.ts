...
export function cartridgeaccount_new(a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number, i: number, j: number, k: number, l: number, m: number, n: number, o: number, p: number, q: number, r: number, s: number): void;
export function cartridgeaccount_createSession(a: number, b: number, c: number, d: number): number;
export function cartridgeaccount_estimateInvokeFee(a: number, b: number, c: number, d: number, e: number, f: number): number;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hafa7db32f8a7bfa7(a: number, b: number, c: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h059e0dabba9887bf(a: number, b: number, c: number, d: number): void;
