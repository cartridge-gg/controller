// Pulled from https://github.com/xJonathanLEI/starknet-rs/blob/starknet-providers/v0.10.0/starknet-accounts/src/factory/mod.rs
    ...
    async fn estimate_fee_with_nonce(
        ...
        self.factory
            ...
            .estimate_fee_single(
                ...
                &vec![SimulationFlagForEstimateFee::SkipValidate], // force skip validate
    ...
    F: AccountFactory,
{
    ...
    async fn get_deploy_request(
        ...
        let signature = if skip_validation {
            vec![]
        } else {
            self.factory.sign_deployment(&self.inner).await?
        };
