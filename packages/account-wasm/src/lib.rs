...
trait CloneableHashSigner: HashSigner + Send + Sync + Clone {}
impl<T: HashSigner + Send + Sync + Clone> CloneableHashSigner for T {}

#[wasm_bindgen]
pub struct CartridgeAccount {
    controller:
        Controller<Arc<CartridgeJsonRpcProvider>, WebauthnSigner<BrowserBackend>, BrowserBackend>,
}
