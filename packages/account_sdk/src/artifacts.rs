...
pub enum Version {
    V1_0_4, V1_0_5, V1_0_6, V1_0_7, V1_0_8, V1_0_9, LATEST
}
...
lazy_static! {
    pub static ref CONTROLLERS: HashMap<Version, ContractClass> = {
        ...
        m.insert(Version::LATEST, ContractClass {
            ...
            casm_hash: felt!("0x462d4f81293ffa97dc725e28179dfa8e7160b4b92f00c8dc2acd248bcd9cc01"),
            ...
            casm_hash: felt!("0x60eda0e15a5a5962b4866793e86a074ce22490debf9449fb62d12f28a534c78"),
        });m.insert(Version::V1_0_6, ContractClass {
            ...
            casm_hash: felt!("0x7ec32f8e2fa07937a81215894f48a3c9af93dc47c88ac6d6852b3fd39f7a6af"),
        });m.insert(Version::V1_0_5, ContractClass {
            ...
            casm_hash: felt!("0x46b6264bd23cdea881b1b1110d7e1e5408507fa847f053ca9b272f4cbe1d55c"),
        });m.insert(Version::V1_0_4, ContractClass {
            ...
            casm_hash: felt!("0x6b22de13b878ab346fa53442adaa8a40a6bd25732aa1aeb2a26375987f0be00"),
        });m.insert(Version::V1_0_9, ContractClass {
            ...
            casm_hash: felt!("0x2fcd4b347622fd2dbe973ad873666f8925b3f244120793014248b4fd9670bd9"),
        });m.insert(Version::V1_0_8, ContractClass {
            ...
            casm_hash: felt!("0x2f2386cd9bea7724f79d8c392b6b99228721d1e8769b1b482287520dfc4d3eb"),
        });
        m
    };

    pub static ref DEFAULT_CONTROLLER: &'static ContractClass = CONTROLLERS.get(&Version::V1_0_9).unwrap();

    pub static ref VERSIONS: Vec<Version> = vec![
        Version::V1_0_4, Version::V1_0_5, Version::V1_0_6, Version::V1_0_7, Version::V1_0_8, Version::V1_0_9, Version::LATEST
    ];
}
