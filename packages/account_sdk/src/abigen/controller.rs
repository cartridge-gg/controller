...
impl<A: starknet::accounts::ConnectedAccount + Sync> Controller<A> {
    ...
    pub fn get_stark_owner(
        ...
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
            entry_point_selector: starknet::macros::selector!("get_stark_owner"),
            calldata: __calldata,
        };
        cainome::cairo_serde::call::FCall::new(__call, self.provider())
    }
...
impl<P: starknet::providers::Provider + Sync> ControllerReader<P> {
    ...
    #[allow(clippy::ptr_arg)]
    #[allow(clippy::too_many_arguments)]
    pub fn get_stark_owner(&self) -> cainome::cairo_serde::call::FCall<P, Option<Signer>> {
        use cainome::cairo_serde::CairoSerde;
        let mut __calldata = vec![];
        let __call = starknet::core::types::FunctionCall {
            contract_address: self.address,
