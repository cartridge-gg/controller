// Taken from:
// https://github.com/argentlabs/argent-contracts-starknet/blob/main/src/signer/eip191.cairo

use controller_auth::signer::{Eip191Signer, is_valid_secp256k1_signature};
use core::integer::{u128_byte_reverse, u256_safe_div_rem, u256_as_non_zero};
