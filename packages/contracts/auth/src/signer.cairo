...
use starknet::secp256_trait::{
    Secp256PointTrait, Signature as Secp256r1Signature, recover_public_key
};
...
enum SignerSignature {
    ...
    Secp256k1: (Secp256k1Signer, Secp256r1Signature),
...
fn is_valid_secp256k1_signature(
    hash: u256, signer: Secp256k1Signer, signature: Secp256k1Signature
) -> bool {
...
fn is_valid_secp256r1_signature(
    hash: u256, pubkey: NonZero<u256>, signature: Secp256r1Signature
) -> bool {
