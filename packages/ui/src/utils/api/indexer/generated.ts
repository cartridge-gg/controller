...
export const useInfiniteEventsQuery = <TData = EventsQuery, TError = unknown>(
  variables: EventsQueryVariables,
...
>(
  ...
  useQuery<Erc721BalancesQuery, TError, TData>(
    ...
    useFetchData<Erc721BalancesQuery, Erc721BalancesQueryVariables>(
      Erc721BalancesDocument,
    ).bind(null, variables),
    options,
  );
...
>(
  ...
  const query = useFetchData<Erc721BalancesQuery, Erc721BalancesQueryVariables>(
    Erc721BalancesDocument,
  );
...
>(
  ...
  useQuery<TokenTransfersQuery, TError, TData>(
    ...
    useFetchData<TokenTransfersQuery, TokenTransfersQueryVariables>(
...
>(
  ...
  const query = useFetchData<TokenTransfersQuery, TokenTransfersQueryVariables>(
    TokenTransfersDocument,
  );
