...
export type CreateCryptoPaymentInput = {
  ...
  /**
   * Contract address of the token the user is depositing. Must be a supported
   * token for the network (validated server-side). Determines which team pool
   * is credited on FUNDED.
   */
  tokenAddress: Scalars["String"];
  /**
   * Amount the user will deposit in the token's native decimals
   * (e.g. USDC 6-dec wei, STRK 18-dec wei). This is the net amount that will
   * be credited to the target pool on FUNDED — no processing fee is deducted.
   */
...
export type Paymaster = Node & {
  ...
  budget: Scalars["Int"];
  /** Unit of the paymaster budget. Set at creation, cannot change. */
...
export type TeamStrkHistory = Node & {
  __typename?: "TeamStrkHistory";
  /** Amount in microSTRK (6-dec) */
  amount: Scalars["Int"];
  /** Optional comment for transaction reason */
  comment?: Maybe<Scalars["String"]>;
  createdAt: Scalars["Time"];
  ...
  teamID: Scalars["String"];
  /** Type of transaction: credit or debit */
  transactionType: TeamStrkHistoryTransactionType;
  updatedAt: Scalars["Time"];
};

/** Ordering options for TeamStrkHistory connections */
export type TeamStrkHistoryOrder = {
  /** The ordering direction. */
  direction?: OrderDirection;
  /** The field by which to order TeamStrkHistories. */
  field: TeamStrkHistoryOrderField;
};

/** Properties by which TeamStrkHistory connections can be ordered. */
export enum TeamStrkHistoryOrderField {
  CreatedAt = "CREATED_AT",
}

/** TeamStrkHistoryTransactionType is enum for the field transaction_type */
export enum TeamStrkHistoryTransactionType {
  Credit = "credit",
  Debit = "debit",
}

/**
 * TeamStrkHistoryWhereInput is used for filtering TeamStrkHistory objects.
 * Input was generated by ent.
 */
export type TeamStrkHistoryWhereInput = {
  /** amount field predicates */
  amount?: InputMaybe<Scalars["Int"]>;
  amountGT?: InputMaybe<Scalars["Int"]>;
  amountGTE?: InputMaybe<Scalars["Int"]>;
  ...
  amountNEQ?: InputMaybe<Scalars["Int"]>;
  amountNotIn?: InputMaybe<Array<Scalars["Int"]>>;
  and?: InputMaybe<Array<TeamStrkHistoryWhereInput>>;
  /** comment field predicates */
  comment?: InputMaybe<Scalars["String"]>;
  commentContains?: InputMaybe<Scalars["String"]>;
  commentContainsFold?: InputMaybe<Scalars["String"]>;
  ...
  idNEQ?: InputMaybe<Scalars["ID"]>;
  idNotIn?: InputMaybe<Array<Scalars["ID"]>>;
  not?: InputMaybe<TeamStrkHistoryWhereInput>;
  or?: InputMaybe<Array<TeamStrkHistoryWhereInput>>;
  /** team_id field predicates */
  teamID?: InputMaybe<Scalars["String"]>;
  teamIDContains?: InputMaybe<Scalars["String"]>;
  teamIDContainsFold?: InputMaybe<Scalars["String"]>;
  ...
  teamIDNotIn?: InputMaybe<Array<Scalars["String"]>>;
  /** transaction_type field predicates */
  transactionType?: InputMaybe<TeamStrkHistoryTransactionType>;
  transactionTypeIn?: InputMaybe<Array<TeamStrkHistoryTransactionType>>;
  transactionTypeNEQ?: InputMaybe<TeamStrkHistoryTransactionType>;
  transactionTypeNotIn?: InputMaybe<Array<TeamStrkHistoryTransactionType>>;
  /** updated_at field predicates */
  updatedAt?: InputMaybe<Scalars["Time"]>;
  updatedAtGT?: InputMaybe<Scalars["Time"]>;
  updatedAtGTE?: InputMaybe<Scalars["Time"]>;
...
export type TeamWhereInput = {
  ...
  /** strk field predicates */
  strk?: InputMaybe<Scalars["Int"]>;
  strkGT?: InputMaybe<Scalars["Int"]>;
  strkGTE?: InputMaybe<Scalars["Int"]>;
  strkIn?: InputMaybe<Array<Scalars["Int"]>>;
  strkLT?: InputMaybe<Scalars["Int"]>;
  strkLTE?: InputMaybe<Scalars["Int"]>;
  strkNEQ?: InputMaybe<Scalars["Int"]>;
  strkNotIn?: InputMaybe<Array<Scalars["Int"]>>;
...
// `pnpm graphql:gen` because the `playerControls` query and
// `updatePlayerControls` mutation are not yet present on the deployed GraphQL
// schema (https://api.cartridge.gg/query). The source of truth is
// `player-controls.graphql`; re-run `pnpm graphql:gen` once the backend
// contract ships and this whole file (overwrite: true) will be regenerated,
...
export type PlayerControlsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type PlayerControlsQuery = {
  __typename?: "Query";
  playerControls: PlayerControlsFieldsFragment;
};
...
export type UpdatePlayerControlsMutation = {
  __typename?: "Mutation";
  updatePlayerControls: PlayerControlsFieldsFragment;
};
